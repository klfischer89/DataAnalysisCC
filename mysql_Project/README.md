...
1. **_LEERE ZEILEN ÜBERSPRINGEN_**

* Lösche alle Zeilen in denen alle Spalten leer sind

2.  **_FEHLENDE WERTE PRÜFEN → FEHLERLISTE_**
...
3. **_DUPLIKATE PRÜFEN → Nur UNIQUE ticket_id einfügen_**
